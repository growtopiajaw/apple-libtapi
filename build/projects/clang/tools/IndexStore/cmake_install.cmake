# Install script for directory: /root/apple-libtapi/src/llvm/projects/clang/tools/IndexStore
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xIndexStorex" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE SHARED_LIBRARY FILES "/root/apple-libtapi/build/lib/libIndexStore.so.8svn")
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xIndexStorex" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE SHARED_LIBRARY FILES "/root/apple-libtapi/build/lib/libIndexStore.so")
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xIndexStorex" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/local/include" TYPE DIRECTORY FILES "/root/apple-libtapi/src/llvm/projects/clang/tools/IndexStore/../../include/indexstore" FILES_MATCHING REGEX "/[^/]*\\.h$" REGEX "/\\.svn$" EXCLUDE)
endif()
