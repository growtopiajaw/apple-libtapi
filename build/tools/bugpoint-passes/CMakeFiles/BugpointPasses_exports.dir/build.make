...
tools/bugpoint-passes/BugpointPasses.exports: /root/apple-libtapi/src/llvm/tools/bugpoint-passes/bugpoint.exports
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/apple-libtapi/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Creating export file for BugpointPasses"
	cd /root/apple-libtapi/build/tools/bugpoint-passes && echo "LLVM_8 {" > BugpointPasses.exports
	cd /root/apple-libtapi/build/tools/bugpoint-passes && grep -q [[:alnum:]] /root/apple-libtapi/src/llvm/tools/bugpoint-passes/bugpoint.exports && echo "  global:" >> BugpointPasses.exports || :
	cd /root/apple-libtapi/build/tools/bugpoint-passes && sed -e "s/\$$/;/" -e "s/^/    /" < /root/apple-libtapi/src/llvm/tools/bugpoint-passes/bugpoint.exports >> BugpointPasses.exports
	cd /root/apple-libtapi/build/tools/bugpoint-passes && echo "  local: *;" >> BugpointPasses.exports
	cd /root/apple-libtapi/build/tools/bugpoint-passes && echo "};" >> BugpointPasses.exports
...
tools/bugpoint-passes/CMakeFiles/BugpointPasses_exports.dir/clean:
	cd /root/apple-libtapi/build/tools/bugpoint-passes && $(CMAKE_COMMAND) -P CMakeFiles/BugpointPasses_exports.dir/cmake_clean.cmake
